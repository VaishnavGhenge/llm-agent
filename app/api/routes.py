...
from app.services import pdf_service, resume_service, job_service, chat_service
from app.api.models import JobProfileCreate, ChatMessage
...
async def create_job_profile(job_profile: JobProfileCreate, db: Session = Depends(get_db)):
